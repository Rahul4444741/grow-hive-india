    ...
    <section id="courses" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between items-center mb-12">
                <div>
                    <span className="inline-block px-3 py-1 text-sm font-semibold text-primary-700 bg-primary-100 rounded-full mb-2 animate-pulse">Learn & Grow</span>
                    <h2 className="text-3xl md:text-4xl font-extrabold text-dark-900 animate-fade-in">Featured <span className="gradient-text">Courses</span></h2>
                </div>
                <div className="mt-4 md:mt-0 flex space-x-2">
                    <button className="px-4 py-2 bg-primary-600 text-white rounded-lg hover:scale-105 transition-transform btn-hover">All</button>
                    <button className="px-4 py-2 bg-white text-dark-700 rounded-lg hover:bg-gray-100 hover:scale-105 transition-transform">Business</button>
                    <button className="px-4 py-2 bg-white text-dark-700 rounded-lg hover:bg-gray-100 hover:scale-105 transition-transform">Marketing</button>
                    <button className="px-4 py-2 bg-white text-dark-700 rounded-lg hover:bg-gray-100 hover:scale-105 transition-transform">Tech</button>
                </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center mt-12">
                <a href="#" className="px-8 py-3 bg-white text-primary-600 border-2 border-primary-600 rounded-lg hover:bg-primary-600 hover:text-white transition font-bold transform hover:scale-105 inline-flex items-center btn-hover">
                    View All Courses <i className="fas fa-arrow-right ml-2 icon-hover"></i>
                </a>
            </div>
        </div>
    </section>
      ...
      <section id="products" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Enhance your learning experience with our high-quality accessories and gadgets.
            </p>
          </div>
